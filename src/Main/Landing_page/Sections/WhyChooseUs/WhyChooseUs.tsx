...
const Card: React.FC<CardProps> = ({ image, heading, text, shadow }) => (
  <div className={shadow ? "whychooseus-card-b" : "whychooseus-card"}>
...
const WhyChooseUs: React.FC = () => {
  ...
  return (
    <section className="whychooseus">
      <div className="whychooseus-header" style={{ fontWeight: 600 }}>
        <h1>Why SafeGad?</h1>
